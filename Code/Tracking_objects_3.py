...
# PROJECT   : Tracking Objects                                                                                         #
# VERSION   : 1.0                                                                                                      #
# AUTHOR    : Ivo Astudillo                     iaastudillo@utpl.edu.ec                                                #                                                                     #
...
#funcion para encontrar el rango hsv del color verde
def buscarVerde(hsv):
...
#funcion para seguir el color verde
...
#Funcion para encontrar el rango hsv del color rojo
def buscarRojo(hsv):
...
#Funcion para seguir el color rojo
...
#Funcion para encontrar el rango hsv del color amarillo
def buscarAmarillo(hsv):
    amarilloMin = np.array([25, 100, 100], np.uint8)
    amarilloMax = np.array([40, 255, 255], np.uint8)
    amarillo = cv2.inRange(hsv, amarilloMin, amarilloMax)
    return amarillo

#Funcion para seguir el color amarillo
...
#funcion para dibujar el contrail del objeto
...
while (1):
    ...
    cv2.imshow("Traking_objects_3", img)
